    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AnecdoteId = table.Column<long>(nullable: false),
                    TagId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnecdoteTag", x => new { x.AnecdoteId, x.TagId });
                    table.ForeignKey(
                        name: "FK_AnecdoteTag_Anecdotes_AnecdoteId",
                        column: x => x.AnecdoteId,
                        principalTable: "Anecdotes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnecdoteTag_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Anecdotes_Title",
                table: "Anecdotes",
                column: "Title");

            migrationBuilder.CreateIndex(
                name: "IX_AnecdoteTag_TagId",
                table: "AnecdoteTag",
                column: "TagId");
